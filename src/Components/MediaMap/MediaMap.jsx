...
function MediaMap() {
    ...
    const galleryItems = [
        ...
        { id: 2, path: 'https://raw.githubusercontent.com/SJCMN/CCLLC_CRA/main/public/Media/Screen%20Shot%202021-12-05%20at%2010.28.47%20PM.png', gif: '', link: '', description: 'Movie gallery with Open Movie Database OMDB API keyword search, returns title, movie poster image url, and plot description', title: 'Movie Gallery' },
