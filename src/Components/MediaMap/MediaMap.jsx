...
function MediaMap() {
  const galleryItems = [
    {
      id: 1,
      path: "https://raw.githubusercontent.com/SJCMN/CCLLC_CRA/main/public/Media/Screen%20Shot%202021-12-04%20at%2011.29.38%20PM.png",
      gif: "https://media.giphy.com/media/iYEHYWjKCVkeUSfXiB/giphy.gif",
    ...
    },
    {
      ...
      link: "",
      description:
        "Movie gallery with Open Movie Database OMDB API keyword search, returns title, movie poster image url, and plot description",
      title: "Movie Gallery",
    },
    {
      id: 3,
      path: "https://raw.githubusercontent.com/SJCMN/CCLLC_CRA/main/public/Media/Screen%20Shot%202021-12-05%20at%2010.40.29%20PM.png",
      gif: "https://media.giphy.com/media/nxirUB7Xg75Qfvlkhv/giphy.gif",
      link: "",
      description:
        "Pet Hotel React front end with .Net and C# back end with postgreSQL server for adding and tracking pets and owners.",
      title: "Pet Hotel App",
    },
    {
      id: 4,
      ...
      link: "",
      description:
        "React authenticated access routes full-stack CRUD app for adding items with url image and description to database.",
      title: "React Auth App",
    },
    {
      id: 5,
      path: "https://raw.githubusercontent.com/SJCMN/CCLLC_CRA/main/public/Media/Screen%20Shot%202021-12-05%20at%2011.05.35%20PM.png",
      gif: "",
      link: "",
      description:
    ...
    {
      id: 6,
      path: "https://raw.githubusercontent.com/SJCMN/CCLLC_CRA/main/public/Media/Screen%20Shot%202021-12-05%20at%2010.59.16%20PM.png",
      gif: "",
      link: "",
      description:
