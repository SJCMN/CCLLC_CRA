...
function MediaMap() {
    ...
    const galleryItems = [
        ...
        { id: 4, path: 'https://raw.githubusercontent.com/SJCMN/CCLLC_CRA/main/public/Media/Screen%20Shot%202022-01-23%20at%209.23.35%20PM.png, link: '', description: 'React authenticated access routes full-stack CRUD app for adding items with url image and description to database.', title: 'React Auth App' },
